export default {
    ...
    login:{
        ...
        loginButton: "登录",
        registorNow: "还没账号？去注册",
        otherWay: "其他方式：",
        returnLogin: "已有账号，去登录",
    },
    home: {
        pageTitle: "首页",
        banner: {
            content: [
                {title: "任礼游 让流量变现更容易", text: "依托专业的广告技术和产品能力，为您的媒体变现和增收提供一体化服务。",}
            ],
            info: [
                {title: "2000+", text: "活跃APP"},
                {title: "5000+", text: "优质广告主",},
                {title: "6亿+", text: "日均请求次数",},
                {title: "3亿+", text: "月覆盖用户量",},
            ],
        },
        resource: {
            title: "丰富的商业化资源",
            text: "专业的技术服务支持",
            content: [
                {title: "商业资源", text: "覆盖100+行业预算，包括游戏、电商、健身、金融等行业。", image: "/images/index/resource-1.png"},
                {title: "技术资源", text: "技术团队核心成员均来自案例、腾讯、猎豹等大型互联网公司，一站式开发，算力保障，RTB高效竞价增收。", image: "/images/index/resource-2.png"},
                {title: "数据监控", text: "24小时数据自动监控与巡检，实时预警并高效解决，实现第三方数据打通，支持效果转化深度分析。", image: "/images/index/resource-3.png"},
                {title: "技术支持", text: "平台功能强大易用，7*16小时在线技术支持，为客户提供精细化贴心服务。", image: "/images/index/resource-4.png"},
            ],
        },
        access: {
            title: "多样化的接入方式",
            content: [
                {title: "SDK", text: "平台功能强大易用，7*16小时在线技术支持，为客户提供精细化贴心服务。", image: "/images/index/access-1.png"},
                {title: "API", text: "在媒体广告位确认情况下，技术人员按照任礼游SSP提供的API对接文档，实现广告的最终投放。", image: "/images/index/access-2.png"},
                {title: "JS", text: "技术人员将任礼游SSP提供的对应业务代码埋在H5页面，实现广告的最终投放。", image: "/images/index/access-3.png"},
                {title: "程序下发", text: "将任礼游SSP提供的客户端程序自动下发至商业PC上，保持每次开启即启动客户端程序，实现广告的最终投放。", image: "/images/index/access-4.png"},
            ]
        },
        ability: {
            title: "强大的产品能力",
            ...
            content: [
                {
                    ...
                    title: "电商类", text: "在云袭电商场景下全方位为商家提供生意服务，提升用户活跃、下单、购买商品等行为。", light: "【品牌推广】【商品推广】【搜索广告】【定向投放】"},
                {
                    image: "/images/index/solutionMBg2.png",
                    iconActive: "/images/index/solutionTabs2Act.png",
                    icon: "/images/index/solutionTabs2.png",
                    title: "APP应用&游戏", text: "满足客户激活下载转化类的营销需求。", light: "【社交媒体】【应用商店】【精准投放】【数据分析】"},
                {
                    image: "/images/index/solutionMBg3.png",
                    iconActive: "/images/index/solutionTabs3Act.png",
                    icon: "/images/index/solutionTabs3.png",
                    title: "金融", text: "帮助金融机构拓展新客户，扩大市场规模。", light: "【线索留资】【品牌建设】【精准营销】"},
                {
                    image: "/images/index/solutionMBg1.png",
                    iconActive: "/images/index/solutionTabs4Act.png",
                    icon: "/images/index/solutionTabs4.png",
                    title: "运动健康", text: "旗下产品“月野兔”有丰富的场馆资源和C端用户，可以为健身运动行业客户提供全方位解决方案。", light: "【全方位服务】【线上线下一体化】"},
            ]
        },
        joinUs: {
            title: "立即加入我们，助力你获得收益",
        }
    },
    app: {
        pageTitle: "移动变现",
        banner: {title: "移动变现", text: "多平台资源实时投放，利用人工智能算法，分析全行业流量数据，优先展示高单价流量，同步深入优化素材，筛选最适合的客户素材进行精准投放，智能提升变现效率",},
        appSlide: {
            title: "移动APP",
            ...
            content: [
                {
                    ...
                    title: "高效竞价", text: "一次曝光机会将公开向所有应用内竞价广告平台发起竞价 云袭 SSP会选取出价最高的广告进行展示确保开发者收益最大"},
                {
                    image: "/images/product/system2.png",
                    title: "广告分层", text: "精准识别广告，进行分层，自动匹配高净值用户，提升转化，确保优质广告源得到充分的曝光机会"},
                {
                    image: "/images/product/system3.png",
                    title: "高效请求策略", text: "支持串、并行请求，开发者可自行选择，提高价值广告源的曝光机会"},
                {
                    image: "/images/product/system4.png",
                    title: "多维流量分组", text: "相同特征、标签的用户往往存在共同偏好云袭SSP支持将用户进行地区、年龄、设备类型等群组划分投其所好助力精细化运营"},
                {
                    image: "/images/product/system5.png",
                    title: "A/B  test", text: "提供多层流量实验框架，方便实现AB test"},
                {
                    image: "/images/product/system6.png",
                    title: "智能混合瀑布流", text: "混合瀑布流模式融合传统瀑布流和应用内竞价的优势开发者可结合应用特点灵活设置瀑布流"},
            ]
        },
    },
    pc: {
