  ...
  home: {
    ...
    resource: {
      ...
      content: [
        {
          title: "商业资源",
          text: "覆盖100+行业预算，包括游戏、电商、健身、金融等行业。",
          image: "/images/index/resource-1.png",
        },
        {
          title: "技术资源",
          text: "技术团队核心成员均来自案例、腾讯、猎豹等大型互联网公司，一站式开发，算力保障，RTB高效竞价增收。",
          image: "/images/index/resource-2.png",
        },
        {
          title: "数据监控",
          text: "24小时数据自动监控与巡检，实时预警并高效解决，实现第三方数据打通，支持效果转化深度分析。",
    ...
    access: {
      ...
      content: [
        ...
        {
          title: "API",
          text: "在媒体广告位确认情况下，技术人员按照任礼游SSP提供的API对接文档，实现广告的最终投放。",
          image: "/images/index/access-2.png",
        },
        {
          title: "JS",
          text: "技术人员将任礼游SSP提供的对应业务代码埋在H5页面，实现广告的最终投放。",
          image: "/images/index/access-3.png",
        },
        {
          title: "程序下发",
          text: "将任礼游SSP提供的客户端程序自动下发至商业PC上，保持每次开启即启动客户端程序，实现广告的最终投放。",
      ...
      content: [
        {
          ...
          title: "高效竞价",
          text: "一次曝光机会将公开向所有应用内竞价广告平台发起竞价 云袭 SSP会选取出价最高的广告进行展示确保开发者收益最大",
        },
        {
          image: "/images/product/system2.png",
          title: "广告分层",
          text: "精准识别广告，进行分层，自动匹配高净值用户，提升转化，确保优质广告源得到充分的曝光机会",
        },
        {
          image: "/images/product/system3.png",
          title: "高效请求策略",
          text: "支持串、并行请求，开发者可自行选择，提高价值广告源的曝光机会",
        },
        {
          image: "/images/product/system4.png",
          title: "多维流量分组",
          text: "相同特征、标签的用户往往存在共同偏好云袭SSP支持将用户进行地区、年龄、设备类型等群组划分投其所好助力精细化运营",
        },
        {
          image: "/images/product/system5.png",
          title: "A/B  test",
          text: "提供多层流量实验框架，方便实现AB test",
        },
        {
          image: "/images/product/system6.png",
          title: "智能混合瀑布流",
          text: "混合瀑布流模式融合传统瀑布流和应用内竞价的优势开发者可结合应用特点灵活设置瀑布流",
        },
      ],
    },
  },
      ...
      content: [
        {
          ...
          title: "网址导航",
          text: "方便快速找到用户需要的网站入口，包含音乐、视频、小说、游戏、财经等上百个分类的优秀站点，提供最简单便捷的网上导航服务",
        },
        {
          image: "/images/product/pcSlide2.png",
          icon: "/images/product/pcSlide2-1.png",
          title: "桌面图标",
          text: "是用户看到的第一眼最直接展现在桌面上的图标，它的受众面广、冲击力强，合理利用桌面广告位资源的同时也便捷了用户的上网使用",
        },
        {
          image: "/images/product/pcSlide3.png",
          icon: "/images/product/pcSlide3-1.png",
          title: "游戏退弹",
          text: "在网民退出游戏客户端时，自动弹出的图片、Flash等形式的广告，网民对此类广告无所谓喜好或厌恶",
        },
        {
        ...
        },
        {
          ...
          title: "右下角升窗",
          text: "打开指定游戏进程后，从右下角升出的广告，对正常运营及玩家上网不产生任何负面作用",
        },
      ],
    },
    pcAdvantage: {
      ...
      content: [
        {
          ...
          title: "安全稳定，持续发展",
          text: "每项业务均通过严格测试力求创新，无缝衔接，收入可持续",
        },
        {
      ...
      content: [
        {
          ...
          title: "数据收集和监测",
          text: "收集各类广告投放的数据，监测用户的行为、收集竞争者的数据。",
        },
        {
          image: "/images/product/dataService1-2.png",
          title: "数据分析和挖掘",
          text: "用最先进的算法对广告投放过程中的数据进行分析和挖掘，寻找其中的规律与趋势，为决策提供科学的依据。",
        },
        {
          image: "/images/product/dataService1-3.png",
          title: "优化策略输出",
          text: "通过对数据分析的结果，输出一系列针对性的优化策略，如降本增效、改进目标受众等。",
        },
        {
          image: "/images/product/dataService1-4.png",
          title: "监测和评估",
          text: "对投放效果进行监测和评估，了解并分析优化策略的实施效果。",
        },
      ],
    },
    dataQuality: {
      ...
      content: [
        {
          ...
          title: "科技领先",
          text: "我们采用最先进的技术手段和最新的算法，确保数据收集和分析的准确性和精度。",
        },
        {
          image: "/images/product/dataService2-2.png",
          title: "个性化",
          text: "我们的系统可以根据不同企业的需求和特点进行个性化的定制，提供更加精细化的服务。",
        },
        {
          image: "/images/product/dataService2-3.png",
          title: "安全可靠",
          text: "我们的系统非常注重数据安全，采取严格的措施保护客户的数据隐私。",
        },
      ],
    },
    dataCase: {
