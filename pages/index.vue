    ...
    <div class="py-1 md:py-8" style="background-color: #fff">
      <section class="al-container">
        <div class="flex justify-between mb-6">
          <div>
            <h2
              class="md:text-4xl md:mb-2"
              style="color: #333; font-weight: 600"
            >
              新闻中心
            </h2>
            <p
              class="hidden md:block text-xs md:text-2xl"
              style="font-style: italic; color: #d6dbe4"
            >
              NEWS CENTER
            </p>
          </div>
          <div class="flex items-center">
            <div class="bar"></div>
            <p class="text-xs md:text-lg text-slate-400">
              任礼游音讯16年品质保证，值得您信赖的伙伴
            </p>
          </div>
        </div>
        <div class="md:flex">
          <div class="md:w-1/2 mb-8">
            <img
              class="rounded-lg w-full h-52 md:h-100"
              src="http://www.pioneerw.com/3.0/style/image/4.png"
            />
          </div>
